 ...
 *   npm run diag:ao -- --node http://localhost:8734 --fallback https://hb.portalinto.com --process <id>
 */

const DEFAULT_NODE = process.env.VITE_AO_URL || "http://localhost:8734";
const DEFAULT_FALLBACK = process.env.VITE_AO_READ_URL || "https://hb.portalinto.com";
